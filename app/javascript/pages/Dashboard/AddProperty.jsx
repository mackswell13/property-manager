        ...
        fetch(nominatimUrl, {
            ...
            .then(data => {
                if (data && data.length > 0) {
                    ...
                    setSearchError("No results found for this address. Please try a different search.");
                }
            })
            .catch(error => {
        ...
        <>
            ...
            >
                ...
                <div className="flex items-center">
                    ...
                    >
                        <FontAwesomeIcon icon={faQuestionCircle} className="w-full h-full cursor-pointer" />
                    </button>
            ...
            {showAddressModal && (
                <div className="fixed inset-0 bg-none bg-opacity-50 flex items-center justify-center p-4 z-50">
                    <div className="bg-white rounded-lg shadow-xl p-6 w-full max-w-md">
                        <h3 className="text-lg font-medium text-gray-900 mb-4">Look Up Address</h3>
